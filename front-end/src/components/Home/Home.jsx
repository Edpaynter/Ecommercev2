  ...
  return (
    <div>
      ...
      <header class="cursor-light">
          ...
          <div class="container">
            <a class="logo link scroll" href="javascript:void(0)" title="Logo">
              ...
              <img
                ...
                src="company/img/interscape_text_white.png"
              />
            </a>
            ...
            <div class="collapse navbar-collapse" id="agency">
              <div class="navbar-nav ml-auto">
                <a class="nav-link link scroll active" href="#home">
                  Home
                </a>
                <a class="nav-link link scroll" href="#about-us">
                  About Us
                </a>
                <a class="nav-link link scroll" href="#portfolio">
                  Our Work
                </a>
                <a class="nav-link link scroll" href="#clients">
                  Clients
                </a>
                <a class="nav-link link scroll" href="#blog">
                  Our Blog
                </a>
                <a class="nav-link link scroll" href="#contact">
                  Contact Us
                </a>
              ...
              <a
                class="btn btn-medium btn-rounded btn-transparent-white btn-hvr-white ml-3"
          ...
          <div class="container">
            ...
            <div class="shape-right">
              <div class="full-menu-detail hide-cursor">
                ...
                <p>
                  <i class="fas fa-user-alt"></i>David Warrior
                </p>
                <p>
                  <i class="fas fa-mobile-alt"></i>+97 53 49 24 78 36
                </p>
                <p>
                  <i class="fas fa-envelope"></i>contact@megaone.com
                </p>
              </div>
        ...
        <div class="animated-modal hidden quote-content" id="animatedModal">
          ...
          <div class="heading-area pb-2 mx-570">
            ...
            <h2 class="title mt-2">
              Lets start your{" "}
              <span class="alt-color js-rotating">project, website</span>
            </h2>
          </div>
          {/* <!--Contact Form--> */}
          <form class="contact-form" id="modal-contact-form-data">
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <a
                  class="btn btn-large btn-rounded btn-blue btn-hvr-pink modal_contact_btn"
                  href="javascript:void(0);"
                  id="quote_submit_btn"
                >
                  <i
          ...
          >
            <ul>
              ...
              >
                ...
                {/* <!-- LAYER NR. 9 --> */}
                <div
                  class="tp-caption tp-resizeme gradient-text1"
                  ...
                  style={{zIndex: "13", minWidth: "650px", maxWidth: "650px", whiteSpace: "nowrap", fontSize: "70px", lineHeight: "80px", fontWeight: "800", color: "#ffffff", letterSpacing: "0px", fontFamily:"Montserrat"}}
                >
                  Creative
                </div>
                ...
                <div
                  ...
                  style={{"z-index": "14", minWidth: "650px", maxWidth: "650px", whiteSpace: "nowrap", "font-size": "70px", lineHeight: "70px", fontWeight: "700", color: "#ffffff", letterSpacing: "0px", fontFamily:"Montserrat"}}
                >
                  Digital Agency
                </div>
                ...
                >
                  <a
                    class="btn btn-slider btn-rounded btn-blue btn-hvr-white"
                    href="javascript:void(0);"
                  >
                    Learn More
                    <div class="btn-hvr-setting">
                ...
                >
                  ...
                  >
                    <img
                      ...
                      src="company/img/interscape_logo_big.png"
                    />
                  </div>
                </div>
                ...
                {/* <!-- LAYER NR. 14 --> */}
                <div
                  class="tp-caption tp-resizeme hide-cursor"
                ...
                >
                  Scroll Down <i class="ml-2 fas fa-long-arrow-alt-down"></i>
                </div>
              </li>
            </ul>
            <div
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="heading-area mx-570 mb-5">
                ...
                <h2 class="title">
                  We have some{" "}
                  <span class="alt-color js-rotating">great, ideal</span>{" "}
                  talented staff
                </h2>
                <p class="para">
                  There are many variations of passages of Lorem Ipsum
      ...
      <section class="bg-light">
          ...
          <div class="row">
            <div class="col-lg-6 wow fadeInLeft">
              <div class="heading-area">
                <span class="sub-title">We are megaone company</span>
                <h2 class="title">
                  <span class="main-color js-rotating">
                ...
                <a
                  class="btn btn-large btn-rounded btn-blue btn-hvr-pink mt-3"
                  href="javascript:void(0);"
                >
                  Learn More
                  <div class="btn-hvr-setting">
        ...
        {/* <!--Portfolio Start--> */}
        <section
          class="cube-portfolio1 text-center no-transition"
          id="portfolio"
        >
          <div class="container">
            {/* <!--Row--> */}
            ...
            <div class="row wow fadeIn">
              <div class="col-md-12">
                ...
                <div class="cbp-l-filters-button" id="js-filters-mosaic-flat">
                  ...
                  <span class="text-blue"> / </span>
                  <div class="cbp-filter-item" data-filter=".marketing">
                    Marketing
                  </div>
                </div>
                ...
                {/* <!--Portfolio Items--> */}
                <div
                  class="cbp cbp-l-grid-mosaic-flat"
        ...
        <section class="gradient-bg1 text-center" id="clients">
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="heading-area mx-570 mb-5">
                  <h2 class="title text-white m-0">
                    Some <span class="js-rotating">great, ideal</span> words
                    from our clients
                  </h2>
                </div>
              </div>
                  ...
                  <ul class="address list-unstyled">
                    ...
                    <li>
                      ...
                      <span class="address-text">
                        ...
                        <a href="javascript:void(0)">+1 631 1234 5678</a>
                      </span>
                    </li>
                    <li>
                      <span class="address-icon gradient-text2">
                      ...
                      <span class="address-text">
                        <a class="mr-3 alt-color" href="javascript:void(0)">
                          email@website.com
                        </a>
                        <a class="mr-3 alt-color" href="javascript:void(0)">
                          abc@website.com
              ...
              <div class="col-lg-7 mt-4 pt-3 mt-lg-0 pt-lg-0 wow fadeInLeft">
                ...
                <form class="contact-form" id="contact-form-data">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <a
                        class="btn btn-large btn-rounded btn-purple btn-hvr-blue d-block mt-4 contact_btn"
                        href="javascript:void(0);"
                        id="submit_btn"
                      >
                        <i
